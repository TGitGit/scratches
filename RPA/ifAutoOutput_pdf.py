...
"""
このプログラムについて
IfToolのフォルダを箇所毎にフォルダ分けしている場合で調書をpdfで出力する時にGUIを自動で操作します。
...
counter=3  #最初に1回だけ出力している場合は1から指定してください。0が最初となる
...
##    pg.click(x=pe[0],y=pe[1])#調書印刷
    ...
    pr = pg.locateCenterOnScreen("C:/Users/SEKIYA_T/Pictures/property.png", confidence=0.9)
    pg.click(x=pr[0], y=pr[1])  # プロパティ画面へ

    pp = pg.locateCenterOnScreen("C:/Users/SEKIYA_T/Pictures/printout_pdf.png", confidence=0.9)
    pg.click(x=pp[0], y=pp[1])  # 結果のadobe pdfを表示のチェックをオフにする

    pg.press("enter")#プロパティ画面を閉じる
...
##    pg.click(x=ye[0],y=ye[1])
    ...
    for tryCount in range(200):
        try:
            ...
            if pg.locateOnScreen('C:/Users/SEKIYA_T/Pictures/save.png',confidence=0.7):
                 break
    ...
    ok3 = pg.locateCenterOnScreen("C:/Users/SEKIYA_T/Pictures/OK3.png", confidence=0.8)
    pg.click(x=ok3[0], y=ok3[1])  # 出力しました画面のOKボタン
